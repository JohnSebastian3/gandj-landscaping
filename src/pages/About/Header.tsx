...
const Hero = () => {
  return (
    <section
      className={`bg-[url('./assets/hero2.jpg')] h-[75vh] bg-cover bg-center flex justify-center items-center`}
    >
      <div className="bg-black bg-opacity-40 w-full h-full flex justify-center
      items-center">
